...
doc = """
Treatment 3: History Lenth 2 with Posiiton Uncertainty
"""
...
def get_quiz_data():
    return [
        ...
        dict(
            name='b',
            solution=True,
            explanation="True: Only Player 1 learns their position.",
        ),
        dict(
            name='c',
            solution=1,
...
class Player(BasePlayer):
    ...
    b = models.BooleanField(label="You will not learn about your position in the sequence, unless you are Player 1.")
    ...
    #        label="The previous players contributed 2 in total. You have two options.",
    #        widget=widgets.RadioSelectHorizontal,
    #        choices=[[1,'Yes'],[0,'No']])
...
def set_payoffs(group: Group):
    ...
    #Total 16 scenarios
    #sceanrio1 - 1,1,1,1
    if p1.response_0p1==C.ENDOWMENT and p2.response_1p2==C.ENDOWMENT and p3.response_1p34==C.ENDOWMENT and p4.response_1p34==C.ENDOWMENT:
        ...
        print('outcome1')
    #2 - 1,1,1,0
    elif p1.response_0p1==C.ENDOWMENT and p2.response_1p2==C.ENDOWMENT and p3.response_1p34==C.ENDOWMENT and p4.response_1p34==cu(0):
        p1.contribution=C.ENDOWMENT
        p2.contribution=C.ENDOWMENT
        p3.contribution=C.ENDOWMENT
        ...
        print('outcome2')
     #3   1,1,0,1
    elif p1.response_0p1==C.ENDOWMENT and p2.response_1p2==C.ENDOWMENT and p3.response_1p34==cu(0) and p4.response_0p34==C.ENDOWMENT:
        p1.contribution=C.ENDOWMENT
        p2.contribution=C.ENDOWMENT
    ...
    #4  1, 1, 0, 0
    elif p1.response_0p1==C.ENDOWMENT and p2.response_1p2==C.ENDOWMENT and p3.response_1p34==cu(0) and p4.response_0p34==cu(0):
        p1.contribution=C.ENDOWMENT
        p2.contribution=C.ENDOWMENT
        p3.contribution=cu(0)
        p4.contribution=cu(0)
        ...
        print('outcome4')
    #5  1 0 1 1 1
    elif p1.response_0p1==C.ENDOWMENT and p2.response_1p2==0 and p3.response_0p34==C.ENDOWMENT and p4.response_1p34==C.ENDOWMENT:
        p1.contribution=C.ENDOWMENT
        ...
        print('outcome5')
    #6 1 0 1 0
    elif p1.response_0p1==C.ENDOWMENT and p2.response_1p2==cu(0) and p3.response_0p34==C.ENDOWMENT and p4.response_1p34==cu(0):
        p1.contribution=C.ENDOWMENT
        p2.contribution=cu(0)
        p3.contribution=C.ENDOWMENT
        p4.contribution=cu(0)
        ...
        print('outcome6')
    #7 1 0 0 1
    elif p1.response_0p1==C.ENDOWMENT and p2.response_1p2==cu(0) and p3.response_0p34==cu(0) and p4.response_0p34==C.ENDOWMENT:
        p1.contribution=C.ENDOWMENT
        p2.contribution=cu(0)
        p3.contribution=cu(0)
        p4.contribution=C.ENDOWMENT
        ...
        for player in players:
            player.payoff = C.ENDOWMENT - player.contribution + group.individual_share
    #8    1 0 0 0
    elif p1.response_0p1==C.ENDOWMENT and p2.response_1p2==cu(0) and p3.response_0p34==cu(0) and p4.response_0p34==cu(0) :
        p1.contribution=C.ENDOWMENT
        p2.contribution=cu(0)
        p3.contribution=cu(0)
        p4.contribution=cu(0)
        ...
        print('outcome8')
    #9  0 1 1 1
    elif p1.response_0p1==cu(0) and p2.response_0p2==C.ENDOWMENT and p3.response_1p34==C.ENDOWMENT and p4.response_1p34==C.ENDOWMENT :
    ...
    #10  0 1 1 0  
    elif p1.response_0p1==cu(0) and p2.response_0p2==C.ENDOWMENT and p3.response_1p34==C.ENDOWMENT and p4.response_1p34==cu(0):
        p1.contribution=cu(0)
        p2.contribution=C.ENDOWMENT
        p3.contribution=C.ENDOWMENT
        p4.contribution=cu(0)
        ...
        print('outcome10')
    #11  0 1 0 1  
    elif p1.response_0p1==cu(0) and p2.response_0p2==C.ENDOWMENT and p3.response_1p34==cu(0) and p4.response_0p34==C.ENDOWMENT:
        p1.contribution=cu(0)
        p2.contribution=C.ENDOWMENT
        p3.contribution=cu(0)
        p4.contribution=C.ENDOWMENT
        ...
        print('outcome11')
    #12  0 1 0 0   
    elif p1.response_0p1==cu(0) and p2.response_0p2==C.ENDOWMENT and p3.response_1p34==cu(0) and p4.response_0p34==cu(0):
        p1.contribution=cu(0)
        p2.contribution=C.ENDOWMENT
        p3.contribution=cu(0)
        p4.contribution=cu(0)
...
class ContributeP3(Page):
    form_model='player'
    form_fields=['response_0p34','response_1p34']
    def is_displayed(player):
        return player.id_in_group==3
class MyWaitPage4(WaitPage):
    body_text='Waiting for others players to make a decision'
    def is_displayed(player):
        return player.id_in_group>3
