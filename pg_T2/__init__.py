...
doc = """
Treatment 2: History Length 2 with Position Uncertainty.
"""
...
def get_quiz_data():
    return [
        ...
        dict(
            name='b',
            solution=True,
            explanation="True: Only Player 1 and Player 2 learns about their position.",
        ),
        dict(
            name='c',
            solution=1,
...
def creating_session(subsession):
   ...
   # if subsession.round_number == 1:
    ...
    #        subsession.session.vars['selected_round'] = paying_round
...
class Player(BasePlayer):
    ...
    b = models.BooleanField(label="You will not learn about your position in the sequence, unless you are Player 1  or Player 2.")
    ...
    #        label="The previous players contributed 3. Do you want to contribute?",
    #        widget=widgets.RadioSelectHorizontal,
    #        choices=[[1,'Yes'],[0,'No']])
...
#             p.participant.selected_round = random.randint(1, C.NUM_ROUNDS) """
#Position 1     ############
